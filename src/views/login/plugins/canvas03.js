...
function Waves(holder, options) {
	...
	Waves.waves = [];
	Waves.holder = document.getElementById(holder);
...
Waves.prototype.animate = function () {
	...
	animationFrameId = window.requestAnimationFrame(Waves.animate.bind(Waves));
};
